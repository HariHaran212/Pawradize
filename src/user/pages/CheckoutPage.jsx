          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg shadow-accent/50">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" id="country" value={formData.country} onChange={handleInputChange} className="w-full border border-accent rounded-md p-3 focus:ring-2 focus:ring-primary outline-none" required />
              </div>
              <div>
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-semibold mb-2">Contact Email</label>
                <input type="email" id="email" value={formData.email} onChange={handleInputChange} className="w-full border border-accent rounded-md p-3 focus:ring-2 focus:ring-primary outline-none" required />
              </div>
            </div>
          </div>
